/*
 * Stoatworks Labs - About window data for bassalt.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Bassalt is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only bassalt
 ...
 * five, and Bassalt.cpp static_asserts the run so the change cannot land
 * silently.
 */
#pragma once
...
{
    inline constexpr auto name = "bassalt";
    inline constexpr auto slug = "bassalt";
    inline constexpr auto hook = "A lava lamp for Resolume: a heat engine the clip is pushed through";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/bassalt/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/bassalt";
